...
<script src=" {{ asset('steex/layouts/assets/js/pages/dashboard-analytics.init.js')}}"></script>
 ...
 <!-- prismjs plugin -->
 <script src="{{ asset('steex/layouts/assets/libs/prismjs/prism.js')}}"></script>
 <script src="{{ asset('steex/layouts/assets/libs/list.js/list.min.js')}}"></script>
 <script src="{{ asset('steex/layouts/assets/libs/list.pagination.js/list.pagination.min.js')}}"></script>

 <!-- listjs init -->
 <script src="{{ asset('steex/layouts/assets/js/pages/listjs.init.js')}}"></script>

 <!-- Sweet Alerts js -->
 <script src="{{ asset('steex/layouts/assets/libs/sweetalert2/sweetalert2.min.js')}}"></script>
